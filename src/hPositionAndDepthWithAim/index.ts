const _inputCommands: { command: string; value: number }[] = `forward 3
down 9
forward 6
down 3
forward 8
...
const _submarine = new _Submarine();

for (const entry of _inputCommands) {
  _submarine[entry["command"]](entry["value"]);
}

console.log(_submarine.getCurrentPositions());
console.log(_submarine.getFinalValue());
